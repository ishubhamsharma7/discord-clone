            ...
            <DialogContent className='bg-white text-black p-0 overflow-hidden'>
               ...
               <div className='p-6'>
                ...
                <div className='flex items-center mt-2 gap-x-2'>
                    <Input className='bg-zinc-300/50 text-black focus-visible:ring-offset-0' value={inviteUrl} disabled={isLoading}/>
...
/// now we gonna create invite code and page so that person can join the server.